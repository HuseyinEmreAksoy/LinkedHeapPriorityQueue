 ...
 */
public abstract class MaxAbstractPriorityQueue<K,V> implements Maxpq<K,V> {
     ...
     */
    protected MaxAbstractPriorityQueue(Comparator<K> c) { comp = c; }

    /** Creates an empty priority queue based on the natural ordering of its keys. */
    protected MaxAbstractPriorityQueue() { this(new DefaultComparator<K>()); }
